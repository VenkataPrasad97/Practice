...
for it in range(2,maxit+1):
    ...
    if calc_objective1(new_defender)<=calc_objective1(persons_df.iloc[defender_index,0]) or calc_objective2(new_defender) <= calc_objective2(persons_df.iloc[defender_index,0]):
        if calc_objective1(new_defender)<=calc_objective1(persons_df.iloc[attacker_index,0]) and calc_objective2(new_defender) <= calc_objective2(persons_df.iloc[attacker_index,0]):
    ...
    #     ParetoCost(it)=new_defender #check can be combined with above
        ...
        if calc_objective1(persons_df.iloc[defender_index,0])<=calc_objective1(persons_df.iloc[attacker_index,0]) and calc_objective2(persons_df.iloc[defender_index,0]) <= calc_objective2(persons_df.iloc[attacker_index,0]):
        ...
        print("ERROR")
    paretoposition.append(persons_df.iloc[attacker_index,0])
